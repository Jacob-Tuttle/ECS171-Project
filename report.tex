...
\begin{figure*}[h]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.65\columnwidth]{lioversample.png}
        \caption{}
    \end{subfigure}
...
\begin{figure*}[h]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.65\columnwidth]{rbfoversample.png}
        \caption{}
    \end{subfigure}
...
\begin{figure*}[h]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.65\columnwidth]{liundersample.png}
        \caption{}
    \end{subfigure}
...
\begin{figure*}[h]
    ...
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=0.65\columnwidth]{rbfundersample.png}
        \caption{}
    \end{subfigure}
